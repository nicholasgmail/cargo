...
const _assets = {
  ["nitro:bundled:cache:content:content-index.json"]: {
    ...
    meta: {"type":"application/json","etag":"\"2-vyGp6PvFo4RvsFtPoIWeCReyIC8\"","mtime":"2025-09-11T13:22:14.290Z"}
  },
  ["nitro:bundled:cache:content:content-navigation.json"]: {
    import: () => import('../raw/content-navigation.mjs').then(r => r.default || r),
    meta: {"type":"application/json","etag":"\"2-l9Fw4VUO7kr8CvBlt4zaMCqXZ0w\"","mtime":"2025-09-11T13:22:14.290Z"}
  }
};
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "ee4c6a7c-9d3a-4447-8aff-53613efc0754",
...
const localeLoaders = {
  cs: [
    {
      key: "locale_cs_46json_b3b5c54e",
      load: () => import('../_/cs.mjs' /* webpackChunkName: "locale_cs_46json_b3b5c54e" */),
      cache: true
    }
  ],
  en: [
    {
      key: "locale_en_46json_71eac807",
      load: () => import('../_/en.mjs' /* webpackChunkName: "locale_en_46json_71eac807" */),
      cache: true
    }
  ]
};
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=deviyace-width, initial-scale=1"}],"link":[],"style":[{"textContent":":root { color: red }"}],"script":[{"src":"/js/jquery.dropotron.min.js","tagPosition":"bodyClose"},{"src":"/js/jquery.scrolly.min.js","tagPosition":"bodyClose"},{"src":"/js/browser.min.js","tagPosition":"bodyClose"},{"src":"/js/breakpoints.min.js","tagPosition":"bodyClose"},{"src":"/js/util.js","tagPosition":"bodyClose"},{"src":"/js/main.js","tagPosition":"bodyClose"}],"noscript":[{"textContent":"cargo"}]};
...
const _cgqr36Y1QDwvcvdFJZGIh6jMULor3aVExuYY0DMWu0 = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
...
const _WgOWhohKxB86Yah8WTPtvcbk4UbXJ6hDGKZDEUKyE = defineNitroPlugin((nitroApp) => {
  nitroApp.hooks.hook("request", (event) => {
    console.log("\u{1F4E5} Request:", event.path);
  });
  nitroApp.hooks.hook("response", (event, response) => {
    console.log("\u{1F4E4} Response:", event.path, response.status);
  });
});

const plugins = [
  _cgqr36Y1QDwvcvdFJZGIh6jMULor3aVExuYY0DMWu0,
_WgOWhohKxB86Yah8WTPtvcbk4UbXJ6hDGKZDEUKyE
];
...
const _SKGdOm = _messagesHandlerCached;
...
const _EI65wu = defineEventHandler(async (event) => {
...
const _5cn6Lk = defineEventHandler(async (event) => {
...
const _FOyIzc = defineEventHandler(async (event) => {
  const { getContentQuery } = await import('../_/query.mjs');
  const { cacheStorage, serverQueryContent } = await import('../_/storage.mjs').then(function (n) { return n.s; });
...
const _jDNPio = lazyEventHandler(() => {
...
const _lazy_AgBQUO = () => import('../routes/api/contact.post.mjs');
const _lazy_G4nWJq = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/api/contact', handler: _lazy_AgBQUO, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_G4nWJq, lazy: true, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _SKGdOm, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _EI65wu, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _EI65wu, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _EI65wu, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.1757596907961.json', handler: _5cn6Lk, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _FOyIzc, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _FOyIzc, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _FOyIzc, lazy: false, middleware: false, method: "get" },
  { route: '/_ipx/**', handler: _jDNPio, lazy: false, middleware: false, method: undefined },
  { route: '/blog/**', handler: _lazy_G4nWJq, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_G4nWJq, lazy: true, middleware: false, method: undefined }
];
...
export { camelCase as A, isPreview as B, withLeadingSlash as C, withoutTrailingSlash as D, prefixStorage as E, useStorage as F, getPreview as G, defu as H, pascalCase as I, handler as J, appRootTag as a, appRootAttrs as b, appSpaLoaderTag as c, defineEventHandler as d, appSpaLoaderAttrs as e, buildAssetsURL as f, getResponseStatusText as g, getResponseStatus as h, appId as i, defineRenderHandler as j, appTeleportTag as k, appTeleportAttrs as l, getQuery as m, createError$1 as n, appHead as o, publicAssetsURL as p, destr as q, readBody as r, getRouteRules as s, hasProtocol as t, useRuntimeConfig as u, relative as v, joinURL as w, useNitroApp as x, parseMarkdown as y, isRelative as z };
